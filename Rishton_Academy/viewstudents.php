...
<html lang="en">
    ...
    <div class="container-fluid">
        <header>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="viewstudents.html">View Students</a></li>
            ...
            <!-- FORM HTML -->
            <div class="head">
            <h1>Search student data by it's id</h1>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-4 col-xs-12 col-xl-4 col-xxl-4">
                    ...
                    <form action="" method="POST">
                        ...
                        <button type="submit" name="search" >View Student</button>
                    </form>
                               ...
                               // $db = mysqli_select_db($connection, "");
                                ...
                                if(isset($_POST['search']))
                                {
                                    ...
                                    $query = "SELECT * FROM addstudents where studentID='".$studentID."' ";
                                    ...
                                    while($row = mysqli_fetch_array($query_run,MYSQLI_BOTH)) 
                                    {
                                        ?>
                                            <tr>
                                                ...
                                                <td style="color:white;"> <?php echo $row['studentID']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['studentname']; ?> </td>
                                                ...
                                                <td style="color:white;"> <?php echo $row['medical']; ?> </td>
