...
<html lang="en">
    ...
    <div class="container-fluid">
        <header>
            ...
            <!-- FORM HTML -->
            <div class="head">
            <h1>Search teacher data by it's id</h1>
            <h2>Enter your teacher id at below box</h2>
            </div>
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-4 col-xs-12 col-xl-4 col-xxl-4">
                    ...
                    <form action="" method="POST">
                        ...
                        <input type="text" name="teacherID"  placeholder="Enter your Teacher ID" />

                        <button type="submit" name="search" >View Teacher</button>
                    </form>
                               ...
                               // $db = mysqli_select_db($connection, "");
                                ...
                                if(isset($_POST['search']))
                                {
                                    ...
                                    $query = "SELECT * FROM addteacher where teacherID='".$teacherID."' ";
                                    ...
                                    while($row = mysqli_fetch_array($query_run,MYSQLI_BOTH)) 
                                    {
                                        ?>
                                            <tr>
                                                ...
                                                <td style="color:white;"> <?php echo $row['teacherID']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['teacher_name']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['teacher_address']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['teacher_phone']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['teacher_salary']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['teacher_background_check']; ?> </td>
                ...
                <div class="container text-center text-md-start mt-5">
                    ...
                    <div class="row mt-3">
                      ...
                      <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="#!" class="text-reset">Renewal</a>
                            </p>
                            <p>
