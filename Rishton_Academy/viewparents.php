...
<html lang="en">
    ...
    <div class="container-fluid">
        <header>
            ...
            <!-- FORM HTML -->
            <div class="head">
            <h1>Search parent data by it's id</h1>
            <h2>Enter your parent id at below box</h2>
            </div>
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-4 col-xs-12 col-xl-4 col-xxl-4">
                    ...
                    <form action="" method="POST">
                        ...
                        <input type="text" name="parentID"  placeholder="Enter your Parent ID" />

                        <button type="submit" name="search" >View Parent</button>
                    </form>
                               ...
                               // $db = mysqli_select_db($connection, "");
                                ...
                                if(isset($_POST['search']))
                                {
                                    ...
                                    $query = "SELECT * FROM addparents where parentID='".$parentID."' ";
                                    ...
                                    while($row = mysqli_fetch_array($query_run,MYSQLI_BOTH)) 
                                    {
                                        ?>
                                            <tr>
                                                ...
                                                <td style="color:white;"> <?php echo $row['parentID']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['parent_name']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['parent_address']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['parent_email']; ?> </td>
                                                <td style="color:white;"> <?php echo $row['parent_phone']; ?> </td>
